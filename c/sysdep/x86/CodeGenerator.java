package c.sysdep.x86;
import c.sysdep.CodeGeneratorOptions;
import c.ir.*;
import c.entity.*;
import c.asm.*;
import c.ast.Location;
import c.utils.AsmUtils;
import c.utils.ListUtils;
import c.utils.ErrorHandler;
import java.util.*;

public class CodeGenerator implements c.sysdep.CodeGenerator,
    ...
    private void locateParameters(List<Parameters> params) {
        long numWords = PARAM_START_WORD;
        for (Parameters var : params) {
