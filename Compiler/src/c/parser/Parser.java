...
// #@@range/include_stmts{
  final public Declarations include_stmts() throws ParseException {
    trace_call("include_stmts");
    try {
    String libid;
...
// #@@range/include_stmt{
  final public String include_stmt() throws ParseException {
    trace_call("include_stmt");
    try {
    StringBuffer buf = new StringBuffer();
    String n;
      jj_consume_token(47);
    ...
    Params params;
      if (jj_2_5(2147483647)) {
        t = jj_consume_token(VOID);
            {if (true) return new Params(location(t), new ArrayList<Parameters>());}
      } else if (jj_2_6(1)) {
        params = fixedparams();
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 53:
...
// #@@range/param{
  final public Parameters param() throws ParseException {
    trace_call("param");
    try {
    TypeNode t;
    String n;
      t = type();
      n = name();
                        {if (true) return new Parameters(t, n);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("param");
    }
...
// #@@range/primary{
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x8000,0x20000,0x0,0x100000,0x200000,0x100000,0x0,0x200000,0x28004000,0x28004000,0x200000,0x0,0x0,0x2240610e,0x400000,0x2200610e,0x0,0x2000610e,0x2000610e,0x2000610e,0x0,0x0,0x0,0x2240610e,0x0,0x2000610e,0x80000000,0x0,0x0,0x0,0x90000,0x90000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20020000,0x20020000,0x2000610e,0x20000000,0x610e,0x8004000,0x8004000,0x200000,0x2000610e,0x610c,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf640000,0x0,0xf640000,0x0,0xf640000,0xf640000,0xf640000,0x0,0x0,0x0,0xf640000,0x0,0xf640000,0x1ff,0x200,0x400,0x800,0xf000,0xf000,0x10000,0x20000,0x40000,0x180000,0x180000,0x600000,0x600000,0x800000,0x800000,0xf640000,0xf640000,0x0,0x33000000,0x33000000,0x0,0xf640000,0x0,};
   }
